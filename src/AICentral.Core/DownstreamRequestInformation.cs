...
public record DownstreamRequestInformation(string LanguageUrl, string InternalEndpointName, AICallType CallType, AICallResponseType ResponseType, string? DeploymentName, string? Prompt, DateTimeOffset StartDate, TimeSpan Duration);
