...

{
    ...
    public async Task rate_limits()
    {
        ...
        Task<HttpResponseMessage> Call() => _httpClient.PostAsync(
            $"http://azure-with-rate-limiter.localtest.me/openai/deployments/Model1/chat/completions?api-version={OpenAITestEx.OpenAIClientApiVersion}",
            new StringContent(
    ...
    public async Task rate_limits_by_consumer()
    {
        ...
        Task<HttpResponseMessage> Call(string apiKey) => _httpClient.SendAsync(
            new HttpRequestMessage(HttpMethod.Post,
                $"http://azure-with-client-partitioned-rate-limiter.localtest.me/openai/deployments/Model1/chat/completions?api-version={OpenAITestEx.OpenAIClientApiVersion}")
            {
